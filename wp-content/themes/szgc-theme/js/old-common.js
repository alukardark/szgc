...
$(function(){
    ...
    $('.modal-fullscreen-menu .list-group li.active-link').addClass('active-link-curent');
    ...
    $('#modalNavigation').on('shown.bs.modal', function () {
        $('.modal-fullscreen-menu .list-group li').removeClass('active-link');
        $('.modal-fullscreen-menu .list-group li.active-link-curent').addClass('active-link');
...
$(window).on('load resize orienationchange',function(){
    ...
    if($(".section-company h1").length){
        setTimeout(function(){
            if (window.matchMedia('(max-width: 1600px) and (min-width: 993px)').matches){
                var positionWrapper = $(".section-company .wrapper").offset().left+60;
            }else{
                var positionWrapper = $(".section-company .wrapper").offset().left;
            }
