<?php get_header(); ?>
    ...
    <div class="wrapper certificates">
        ...
        <ul class="certificates-list nostyle-list">
                ...
                $custom_query = new WP_Query( array( 'post_type' => 'certificates', 'paged' => $paged ) );

                if ( $custom_query->have_posts() ) : while ( $custom_query->have_posts() ) : $custom_query->the_post(); ?>

                    <li class="certificates-item">
                        <a data-fancybox="certificates" href="<?=get_field('certificates-gallery')['url']?>" class="certificates-img-wrap">
                            <div class="certificates-img" style="background-image: url(<?=get_field('certificates-gallery')['sizes']['certificates']?>)"></div>
                            <p> <? the_title(); ?></p>
                        </a>
                    </li>
